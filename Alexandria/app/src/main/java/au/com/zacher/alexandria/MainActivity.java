...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, Callback
{
    ...
    private BroadcastReceiver _messageReciever;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        _messageReciever = new MessageReciever();
        IntentFilter filter = new IntentFilter(MESSAGE_EVENT);
        LocalBroadcastManager.getInstance(this).registerReceiver(_messageReciever, filter);
    ...
    {
        LocalBroadcastManager.getInstance(this).unregisterReceiver(_messageReciever);
        super.onDestroy();
    }
